...
% Copyright (c) 1999-2015 by Tomlab Optimization Inc., $Release: 8.10.0$
% Written Aug 5, 1999.    Last modified Jan 23, 2014.
...
% 150122 ango Prob.Threads check only for 7.x, not a problem in 8.x
