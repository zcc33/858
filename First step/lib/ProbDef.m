...
% Copyright (c) 1998-2015 by Tomlab Optimization Inc., $Release: 8.1.0$
% Written May 18, 1998.   Last modified Feb 27, 2015. 
...
Prob = struct('TOMLAB','v8.1','MATLAB',[y,z], 'Threads', double(1), 'A', [], ...
